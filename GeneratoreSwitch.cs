...
namespace TelegramBotDemo
{
    internal class GeneratoreSwitch
    {
        ...
        public void SwitchFunzioni(Message messaggio, TelegramBot bot, int contatoreSofferenza, bool offese, int contatoreOffese, int contatorePaolo, int contatoreProfezia)
        {
            try
            {
            ...
            if (Switch(messaggio, comanando, bot, contatoreOffese, contatorePaolo, contatoreProfezia, offese))
                return;

            foreach (var comando in comanando)
            {
               if (Contiene(messaggio, comando, bot, contatoreSofferenza))
               return;
            }
